...
namespace encryption
{
    ...
    public class Node
    {
        ...
        // Коструктор при задании зашифрованного символа
    ...
    // Структура данных список, элементами списка
    // являются кодируемые символы и вся информация о них
    public class List
    {
        // Начало списка
        public Node Head;
        ...
        // Поиск записи в списке по имеющемуся коду
